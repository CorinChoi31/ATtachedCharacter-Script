///dsc_set_motion_part_relative(part, anlge);
function dsc_set_motion_part_relative() {

	///@desciption dsc_set_motion_part_relative(part,angle)
	///@function dsc_set_motion_part_relative(part,angle)
