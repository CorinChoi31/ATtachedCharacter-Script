///dsc_set_control(Body, Head, Left Arm, Left ForeArm, Left Lap, Left Leg, Right Arm, Right ForeArm, Right Lap, Right Leg);
function dsc_set_control() {

	///@desciption dsc_set_control(Body,Head,Left_Arm,Left_ForeArm,Left_Lap,Left_Leg,Right_Arm,Right_ForeArm,Right_Lap,Right_Leg)
	///@function dsc_set_control(Body,Head,Left_Arm,Left_ForeArm,Left_Lap,Left_Leg,Right_Arm,Right_ForeArm,Right_Lap,Right_Leg)
